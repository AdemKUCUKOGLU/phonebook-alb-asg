...
# This "/app/dbserver.endpoint" file has to be created from cloudformation template and it has RDS endpoint
db_endpoint = open("/app/dbserver.endpoint", 'r', encoding='UTF-8') 
